...
import StarterRankRow from './StarterRankRow';
...
class StarterRankView extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="main-content-container">
        <h2 className="pos-rank--title">SP ranks</h2>
        <table className="rank-table" id="StarterTable" ng-show="showStarters">
...
export default connect(mapStateToProps, null)(StarterRankView);
